...
This page manages fleet management dashboard records.
...
| groupid0_ZC_8UDUI1 |  | checkbox | No |
...
| viewdel |  | checkbox | No |
| volume |  | range | No |
| checkbox-Vehicle-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen4 |  | text | No |
| s2id_autogen4_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| checkbox-Date_field1-ZC_8UDUI1 |  | checkbox | No |
...
| From |  | text | No |
| To |  | text | No |
| checkbox-Total_Fuel_Cost-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen8 |  | text | No |
| s2id_autogen8_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| From |  | text | No |
| To |  | text | No |
| checkbox-Fuel_Quantity-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen10 |  | text | No |
| s2id_autogen10_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| From |  | text | No |
| To |  | text | No |
| checkbox-Actual_Consumption-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen12 |  | text | No |
| s2id_autogen12_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| From |  | text | No |
| To |  | text | No |
| checkbox-Status-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen14 |  | text | No |
| s2id_autogen14_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| checkbox-Driver-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen16 |  | text | No |
| s2id_autogen16_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| checkbox-Odometer_Reading-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen18 |  | text | No |
| s2id_autogen18_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| From |  | text | No |
| To |  | text | No |
| checkbox-Fuel_Price_Per_Liter-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen20 |  | text | No |
| s2id_autogen20_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| From |  | text | No |
| To |  | text | No |
| checkbox-Distance_Since_Last_Fuel-ZC_8UDUI1 |  | checkbox | No |
| s2id_autogen22 |  | text | No |
| s2id_autogen22_search |  | text | No |
| zc_searchSelect |  | dropdown | No |
| From |  | text | No |
| To |  | text | No |
| checkbox-Consumption_Deviation-ZC_8UDUI1 |  | checkbox | No |
