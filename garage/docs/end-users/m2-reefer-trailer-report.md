...
![M2 Reefer Trailer Report screenshot](../assets/screenshots/m2-reefer-trailer-report.png)

The M2 Reefer Trailer Report page lets you record and manage maintenance issues for refrigerated trailers in your fleet. Operations staff use this form to document problems found during inspections, assign them to service categories, and track repairs before submitting them to maintenance.

**URL:** `https://creatorapp.zoho.com/m.fahmy_ugologistics/u-go-garage-maintenance#Report:M2_Reefer_Trailer_Report`

## How to Use

1. Select your preferred language from the lang-select-dropdown at the top if needed
2. Use the volume range field to specify the storage capacity or affected area of the reefer trailer being reported
3. For each maintenance issue found, check the corresponding checkbox to activate that repair row
4. In the search field below each checkbox, enter or select the specific maintenance item or component that needs repair
5. Use the dropdown menu next to each item to categorize the repair type or assign it to a maintenance category
6. Repeat steps 3-5 for all issues you've identified on this trailer
7. Click Submit Request when all issues are recorded and verified
...
- Do not leave checkbox items unchecked if you enter information in their corresponding search fields—the system may not save incomplete rows
- Always search existing items first before typing new ones to avoid creating duplicate maintenance records and to keep your database consistent
