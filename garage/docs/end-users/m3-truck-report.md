...
![M3 Truck Report screenshot](../assets/screenshots/m3-truck-report.png)

The M3 Truck Report page lets you record and track maintenance activities for your M3 trucks in the U-Go fleet. Maintenance staff and fleet managers use this form to log completed work, schedule repairs, and maintain compliance records. Access this page when you need to add new maintenance records or update existing truck service history.
...
2. Check the checkbox next to each maintenance item you want to record (Oil Change, Filter Replacement, Inspection, etc.)
3. For each checked item, use the search field to find and select the specific part, service, or maintenance type from the dropdown list
4. Enter any additional details in the text fields, such as work performed or notes about the repair
5. Adjust the Volume slider if tracking quantity or capacity-related maintenance data
6. Review all entries for accuracy, then click Submit Request to save the maintenance record
7. Click Done when finished, or navigate to other sections using the menu buttons if you need to access related forms
...
|-------|-------------|------|----------|
| lang-select-dropdown | Choose your working language for the form interface | dropdown | No |
| volume | Enter or adjust the quantity, capacity, or numeric measurement related to the maintenance work being logged | range | No |
...
- Always check the correct checkbox first before filling in details—this ensures the maintenance record is properly categorized and linked to the right truck task
- Use the search fields instead of scrolling through long dropdown lists; typing the part name or service code saves time and reduces selection errors
