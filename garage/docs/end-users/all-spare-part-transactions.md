...
![All Spare Part Transactions screenshot](../assets/screenshots/all-spare-part-transactions.png)

This page displays all spare parts transactions for your garage maintenance operations, allowing you to view, manage, and track purchase history from suppliers. Use this page to monitor parts received, verify supplier information, and maintain records of all spare parts acquisitions. Operations staff access this to reconcile inventory, audit supplier pricing, and generate reports.

**URL:** `https://creatorapp.zoho.com/m.fahmy_ugologistics/u-go-garage-maintenance#Report:All_Spare_Part_Transactions`

## How to Use

1. Open the All Spare Part Transactions page from the Spare Parts menu
2. Use the language dropdown at the top if you need to switch the interface language
3. Review the transaction table to find the parts record you need—filter or scroll through Transaction Date, Supplier Name, and Unit Price columns
4. Select individual part records by checking the corresponding checkboxes if you need to perform bulk actions
5. Click Print to generate a report, Export to download data, or Bulk Edit to update multiple records at once
6. To add a new spare parts transaction, click Add (or press Option + Shift + N) and enter Supplier Name, Contact Person, Phone, Unit Price, and Quantity
7. Attach any supporting documents like invoices or delivery notes using the File upload column, then click Done
...
|-------|-------------|------|----------|
| lang-select-dropdown | Choose your preferred language for the user interface. Select your language and the page will refresh. | dropdown | No |
...
- The numbered checkboxes represent individual spare part items in your system. Check only the items you want to modify to avoid accidental bulk changes to unrelated parts.
- Always attach file documentation (invoices, receipts) when recording transactions—this protects your records during audits and helps resolve supplier disputes quickly.
